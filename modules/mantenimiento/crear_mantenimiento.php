...
<head>
    ...
    <title>Crear Mantenimiento - SmartRepair</title>
   ...
   <?php
    ...
    <div class="main">
        ...
        <div class="form-container">
            <div class="form-header">
                <h2 class="form-title">Nuevo Mantenimiento</h2>
                <a href="index_mantenimiento.php" class="btn-back">
                    <ion-icon name="arrow-back-outline"></ion-icon> Volver
                </a>
            </div>

            <form action="procesar_crear_mantenimiento.php" method="POST" id="formCrearMantenimiento">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_tipo_mantenimiento" id="id_tipo_mantenimiento" required>
                            ...
                            <?php while ($tipo = mysqli_fetch_assoc($result_tipos)): ?>
                                <option value="<?php echo $tipo['id_tipo_mantenimiento']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="fecha_mantenimiento" id="fecha_mantenimiento" required>
                    </div>

                    <div class="form-group full-width">
                        <label for="actividades_realizadas">Actividades Realizadas <span class="required">*</span></label>
                        <textarea name="actividades_realizadas" id="actividades_realizadas" required placeholder="Describa las actividades realizadas durante el mantenimiento..."></textarea>
                    </div>

                    <div class="form-group full-width">
                        <label for="repuestos_utilizados">Repuestos Utilizados</label>
                        <textarea name="repuestos_utilizados" id="repuestos_utilizados" placeholder="Liste los repuestos o materiales utilizados (opcional)..."></textarea>
                    </div>

                    <div class="form-group full-width">
                        <label for="observaciones">Observaciones</label>
                        <textarea name="observaciones" id="observaciones" placeholder="Observaciones adicionales (opcional)..."></textarea>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn-submit">
                        <ion-icon name="save-outline"></ion-icon> Guardar Mantenimiento
                    </button>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('fecha_mantenimiento').value = now.toISOString().slice(0, 16);
        });

        // Validación del formulario
        document.getElementById('formCrearMantenimiento').addEventListener('submit', function(e) {
