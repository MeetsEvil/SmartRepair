...
// Solo administradores pueden editar líneas
...
$sql = "SELECT * FROM lineas WHERE id_linea = $id_linea";
...
<head>
    ...
    <title>Editar Línea - SmartRepair</title>
    ...
    <div class="main">
        ...
        <div class="form-container">
            <div class="form-header">
                <h2 class="form-title">Editar Línea de Producción</h2>
                <a href="index_lineas.php" class="btn-cancel">
                    <ion-icon name="arrow-back-outline"></ion-icon> Regresar
                </a>
            </div>

            <form id="formEditarLinea" class="form-content" method="POST" action="procesar_editar_linea.php">
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="nombre_linea" name="nombre_linea" class="form-input" required maxlength="100"
                        value="<?php echo htmlspecialchars($linea['nombre_linea']); ?>">
                </div>
                    ...
                    <select id="id_planta" name="id_planta" class="form-select" required>
                        ...
                        <?php while ($planta = mysqli_fetch_assoc($plantas)): ?>
                            <option value="<?php echo $planta['id_planta']; ?>" 
                                <?php echo ($planta['id_planta'] == $linea['id_planta']) ? 'selected' : ''; ?>>
                    ...
                    <select id="id_prioridad" name="id_prioridad" class="form-select" required>
                        ...
                        <?php while ($prioridad = mysqli_fetch_assoc($prioridades)): ?>
                            <option value="<?php echo $prioridad['id_prioridad']; ?>"
                                <?php echo ($prioridad['id_prioridad'] == $linea['id_prioridad']) ? 'selected' : ''; ?>>
                ...
                <div class="form-row">
                    ...
                    <textarea id="descripcion" name="descripcion" class="form-textarea"><?php echo htmlspecialchars($linea['descripcion']); ?></textarea>
                </div>
                ...
                <div class="form-row">
                    ...
                    <select id="estado" name="estado" class="form-select" required>
                        <option value="Activa" <?php echo ($linea['estado'] == 'Activa') ? 'selected' : ''; ?>>Activa</option>
                        <option value="Inactiva" <?php echo ($linea['estado'] == 'Inactiva') ? 'selected' : ''; ?>>Inactiva</option>
                    </select>
                </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        <ion-icon name="save-outline"></ion-icon> Actualizar Línea
                    </button>
                    <a href="index_lineas.php" class="btn-cancel">
    ...
    <div id="successModal" class="modal">
        <div class="modal-content success">
            <div class="modal-body">
                ...
                <p>La línea de producción ha sido actualizada correctamente.</p>
