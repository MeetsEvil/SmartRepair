...
<head>
    ...
    <title>Editar Usuario - SmartRepair</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="form-container">
            ...
            <form id="formEditarUsuario" class="form-content" method="POST" action="procesar_editar_usuario.php">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-column">
                        ...
                        <div class="form-row">
                            ...
                            <div>
                                <div class="password-wrapper">
                                    <input type="password" id="password" name="password" class="form-input" minlength="6" maxlength="50">
                        ...
                        <div class="form-row">
                            ...
                            <div class="password-wrapper">
                                <input type="password" id="password_confirm" name="password_confirm" class="form-input" minlength="6" maxlength="50">
                            ...
                            <select id="id_rol" name="id_rol" class="form-select" required>
                                ...
                                <?php while ($rol_item = mysqli_fetch_assoc($roles)): ?>
                                    <option value="<?php echo $rol_item['id_rol']; ?>" 
                                        <?php echo ($rol_item['id_rol'] == $usuario['id_rol']) ? 'selected' : ''; ?>>
                            ...
                            <select id="id_planta" name="id_planta" class="form-select">
                                ...
                                <?php while ($planta = mysqli_fetch_assoc($plantas)): ?>
                                    <option value="<?php echo $planta['id_planta']; ?>"
                                        <?php echo ($planta['id_planta'] == $usuario['id_planta']) ? 'selected' : ''; ?>>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        <ion-icon name="save-outline"></ion-icon> Actualizar Usuario
                    </button>
                    <a href="index_usuarios.php" class="btn-cancel">
