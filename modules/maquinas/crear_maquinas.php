...
// Solo administradores y técnicos pueden crear máquinas
...
<head>
    ...
    <title>Crear Máquina - SmartRepair</title>
    ...
    <div class="main">
        ...
        <div class="form-container">
            <div class="form-header">
                <h2 class="form-title">Crear Nueva Máquina</h2>
            ...
            <form id="formCrearMaquina" class="form-content" method="POST" action="procesar_crear_maquina.php" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <select id="id_linea" name="id_linea" class="form-select" required>
                        ...
                        <?php while ($linea = mysqli_fetch_assoc($lineas)): ?>
                            <option value="<?php echo $linea['id_linea']; ?>" data-planta="<?php echo $linea['id_planta']; ?>">
                ...
                <div class="form-row">
                    ...
                    <textarea id="observaciones" name="observaciones" class="form-textarea" 
                        placeholder="Ingrese observaciones adicionales sobre la máquina"></textarea>
                </div>

                <!-- Botones de acción -->
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        <ion-icon name="save-outline"></ion-icon> Crear Máquina
                    </button>
                    <a href="index_maquinas.php" class="btn-cancel">
    ...
    <div id="successModal" class="modal">
        <div class="modal-content success">
            <div class="modal-body">
                ...
                <h2 class="success-title">¡Máquina Creada!</h2>
                <p>La máquina ha sido registrada correctamente en el sistema.</p>
